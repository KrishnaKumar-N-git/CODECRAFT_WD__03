/**
 * Self-contained SVG image library for GrocMart Grocery Stores.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="100%" height="100%">
  ...
  <!-- Main Illustration White Pill Container -->
  <circle cx="250" cy="220" r="140" fill="#ffffff" opacity="0.95" filter="url(#s)" />

  <!-- Dynamic Vector Graphic Icon -->
...
// Preset SVGs for all categories & product types
const svgs = {
  // 1. Fruits & Vegetables
...
const getProductSvg = (productName = '', categoryName = '') => {
